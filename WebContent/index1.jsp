        ...
        <div class="container-fluid">
            ...
            <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
                ...
                <div class="collapse navbar-collapse" id="navbarNavDropdown">
                  <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                      <a class="nav-link text-white " style="font-size: x-large;" href="showRequest.jsp"><i class="fa fa-bell-o"></i>
                        Requests</a>
                    </li>
                ...
                <div id="demo" class="carousel slide" data-ride="carousel" data-interval="1000">
                    ...
                    <div class="carousel-inner ">
                      <div class="carousel-item active">
                        <img src="calculator.jpg" alt="image not found" class="img img-fluid" >
                      </div>
                      <div class="carousel-item">
                        <img src="sheetHolder.jpg" alt="image not found" class="img img-fluid" >
                      </div>
                      <div class="carousel-item">
                        <img src="DC.jpg" alt="image not found" class="img img-fluid" >
                      </div>
                    </div>
    		...
    		try
    			{
    				...
    				PreparedStatement ps=con.prepareStatement("select * from product where status=?");
    				ps.setString(1,"Yes");
    		...
    		%>
    		 <div class="col-md-3 mt-5">
                  <a href="viewProduct1.jsp?id=<%=id %>" >  <img src="data:image/gif;base64,<%=imgDataBase64 %>" class="img img-fluid h-100 w-100"></a>
