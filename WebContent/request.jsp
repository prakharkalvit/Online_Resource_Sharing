...
<body>
    ...
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <h1 class="h1 text-center">Requests</h1>
        ...
        <tbody style="text-align: center;">
    		...
    		%>
                ...
                <td><a href="adminAcceptRequest.jsp?id=<%=id%>" class="btn btn-warning">Accept</a> <a href="adminDenyRequest.jsp?id=<%=id %>" class="btn btn-danger ml-5">Deny</a></td>
    	 </tr>
    	<% 
    		}while(rs.next());
    					con.close();
