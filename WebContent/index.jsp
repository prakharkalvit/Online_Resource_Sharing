...
background: none;
    ...
    <body>
        <div class="container-fluid">
    		...
    		%>
    		 <div class="col-md-3 col-lg-3 col-sm-12 col-12 mt-5 " >
                  <a href="viewProduct.jsp?id=<%=id%>">  <img src="data:image/gif;base64,<%=imgDataBase64 %>" class="img img-fluid" style="height:400px;width:auto"></a>
